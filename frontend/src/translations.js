...
export const translations = {
  en: {
    ...
    retry: "Try again",
    estimatedNote: "Estimated rates for comparison, before fees — confirm the fee with each provider.",
    ...
    checkProvider: "Check with provider",
    currencies: {
      EUR: "Euro (EUR)",
  ...
  hi: {
    ...
    estimatedNote: "तुलना के लिए अनुमानित दरें, शुल्क से पहले — प्रत्येक प्रदाता से शुल्क की पुष्टि करें।",
    trendUnavailable: "इस मुद्रा के लिए ऐतिहासिक रुझान डेटा अभी उपलब्ध नहीं है।",
    estimatedShort: "अनुमानित",
    verified: "{date} को सत्यापित",
    checkProvider: "प्रदाता से जाँचें",
    currencies: {
      EUR: "यूरो (EUR)",
  ...
  ur: {
    ...
    estimatedNote: "موازنے کے لیے تخمینی ریٹس، فیس سے پہلے — ہر فراہم کنندہ سے فیس کی تصدیق کریں۔",
    trendUnavailable: "اس کرنسی کے لیے تاریخی رجحان کا ڈیٹا ابھی دستیاب نہیں ہے۔",
    estimatedShort: "تخمینی",
    verified: "{date} کو تصدیق شدہ",
    checkProvider: "فراہم کنندہ سے معلوم کریں",
    currencies: {
      EUR: "یورو (EUR)",
  ...
  tl: {
    ...
    retry: "Subukan muli",
    estimatedNote: "Tinatayang presyo para sa paghahambing, bago ang bayarin — kumpirmahin ang bayarin sa provider.",
    trendUnavailable: "Wala pang historical trend data para sa currency na ito.",
    estimatedShort: "Tinatantiya",
    verified: "Na-verify {date}",
    checkProvider: "Tanungin ang provider",
    currencies: {
      EUR: "Euro (EUR)",
      INR: "Indian Rupee (INR)",
      PKR: "Pakistani Rupee (PKR)",
